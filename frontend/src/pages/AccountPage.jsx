...
import { LogOut, Loader2, Package, User, MapPin, ArrowRight, ShieldCheck } from "lucide-react";
        ...
        <div className="rounded-[32px] border border-baume-border bg-baume-white px-6 md:px-10 lg:px-12 py-10 md:py-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <button
              ...
              className="h-12 px-6 inline-flex items-center gap-2 rounded-full border border-baume-border text-baume-charcoal text-[14px] font-semibold hover:border-baume-burgundy hover:text-baume-burgundy transition-colors"
            >
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <MiniStat icon={Package} title="Commandes" value={`${orders.length}`} />
            ...
            >
              <div>
                ...
                <p className="mt-2 text-[14px] text-baume-charcoal/65">
                  Ces informations permettent de préparer vos commandes et vos rendez-vous plus rapidement.
                </p>
              </div>
