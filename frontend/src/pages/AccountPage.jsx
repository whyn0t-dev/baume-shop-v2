							...
							<AnimatePresence>
								{user?.role === "admin" && (
									<motion.button
										...
										className="h-12 px-inline-flex items-center gap-2 rounded-full bg-baume-burgundy text-baume-white text-[14px] font-semibold hover:opacity-90 transition-opacity"
									>
