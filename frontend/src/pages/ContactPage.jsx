    ...
    <div data-testid="contact-page" className="bg-baume-ivory">
      ...
      <div className="baume-container py-10 md:py-14">
        <h1 className="font-editorial text-[40px] md:text-[56px] leading-[1.05] text-baume-charcoal max-w-[720px]">
          Parlez-nous de votre besoin, <span className="italic text-baume-burgundy">on vous répond avec douceur</span> et précision.
        </h1>
      </div>
      ...
      <div className="baume-container pb-24 grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-baume-white border border-baume-border rounded-2xl p-6">
            <p className="font-editorial text-[22px] text-baume-charcoal mb-5">Moyens de nous joindre</p>
            <ul className="space-y-4 text-[14px]">
              <li className="flex gap-3">
                <MapPin className="h-5 w-5 text-baume-burgundy shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold text-baume-charcoal">Boutique Genève</p>
                  <p className="text-baume-charcoal/70">Rue du Rhône 15, 1204 Genève</p>
                </div>
              </li>
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-baume-charcoal/70">Mardi – Samedi · 10h – 19h</p>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:bonjour@baume-shop.com" className="text-baume-burgundy baume-link">bonjour@baume-shop.com</a>
                </div>
              </li>
              <li className="flex gap-3">
        ...
        <div className="lg:col-span-7">
          ...
          >
            <p className="font-editorial text-[24px] text-baume-charcoal">Envoyer un message</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="name">Nom</Label>
                <Input id="name" data-testid="contact-name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className="mt-1.5 h-12 rounded-lg border-baume-border focus-visible:ring-baume-burgundy" />
              </div>
              <div>
                <Label htmlFor="c-email">Email</Label>
                <Input id="c-email" type="email" data-testid="contact-email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="mt-1.5 h-12 rounded-lg border-baume-border focus-visible:ring-baume-burgundy" />
              </div>
            </div>
            ...
            <div>
              ...
              <Select value={form.topic} onValueChange={(v) => setForm({ ...form, topic: v })}>
                <SelectTrigger id="topic" data-testid="contact-topic" className="mt-1.5 h-12 rounded-lg border-baume-border">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Input id="subject" data-testid="contact-subject" value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })} className="mt-1.5 h-12 rounded-lg border-baume-border focus-visible:ring-baume-burgundy" />
            </div>
            ...
            <p className="text-[12px] text-baume-charcoal/60">Nous vous répondons sous 24 h ouvrées.</p>
          </form>
        </div>
      </div>
    </div>
