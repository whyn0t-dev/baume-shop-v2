...
import { CheckCircle2, ArrowRight, XCircle, Loader2, RefreshCw } from "lucide-react";
...
export default function ConfirmationPage() {
  ...
  return (
    <div data-testid="confirmation-error-page" className="bg-baume-ivory min-h-[70vh]">
      <div className="baume-container py-20 md:py-28 max-w-[720px] mx-auto text-center">
        ...
        <div className="mt-8 rounded-2xl border border-baume-border bg-baume-white p-6 text-left space-y-3">
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-2 text-[13px] text-baume-charcoal/70">
