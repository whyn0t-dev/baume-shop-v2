				...
				{isPaid ? (
					...
					<>
						...
						<p className="mt-4 text-[15px] text-baume-charcoal/75">
							Votre paiement n'a pas pu être confirmé. Votre panier est toujours
							disponible — vous pouvez réessayer ou nous contacter.
						</p>
						<div className="mt-10 flex flex-wrap justify-center gap-3">
							<Link
								to="/panier"
								className="h-12 px-8 inline-flex items-center rounded-full bg-baume-burgundy text-baume-white font-semibold text-[15px]"
							>
								Retour au panier
							</Link>
							<Link
					...
					<>
						...
						<h1 className="font-editorial text-[28px] text-baume-charcoal">
							Vérification du paiement…
						</h1>
						<p className="mt-3 text-[14px] text-baume-charcoal/70">
							Merci de patienter quelques secondes (tentative {attempt + 1}/8).
						</p>
					</>
				)}
			</div>
