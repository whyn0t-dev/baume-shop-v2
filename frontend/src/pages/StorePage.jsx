...
import { Clock, MapPin, Phone, Calendar, ArrowRight, Sparkles } from "lucide-react";
          ...
          <div className="absolute inset-0 flex items-end p-6 md:p-12">
            <div className="max-w-[720px] text-baume-white">
              ...
              <p className="mt-4 text-[16px] md:text-[18px] leading-[28px] text-baume-white/85 max-w-[560px]">
                Un lieu calme pour être conseillée, découvrir les produits et prendre le temps de choisir.
              </p>
            </div>
          </div>
        </div>
        ...
        <main className="lg:col-span-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="aspect-square rounded-3xl overflow-hidden border border-baume-border">
              <img src="https://images.unsplash.com/photo-1714648893954-3744b033f226?crop=entropy&cs=srgb&fm=jpg&w=900&q=80" alt="" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
            </div>
            <div className="aspect-square rounded-3xl overflow-hidden border border-baume-border">
              <img src="https://images.unsplash.com/photo-1745565610492-b70156cec381?crop=entropy&cs=srgb&fm=jpg&w=900&q=80" alt="" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
            </div>
            <div className="aspect-[21/9] rounded-3xl overflow-hidden border border-baume-border col-span-2">
              <img src="https://images.unsplash.com/photo-1777008873256-fcdf52ae61b3?crop=entropy&cs=srgb&fm=jpg&w=1800&q=80" alt="" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
            </div>
          </div>
...
function MiniFeature({ title }) {
  return (
    <div className="rounded-2xl bg-baume-ivory border border-baume-border px-4 py-4 flex items-center gap-3">
      ...
      <span className="text-[14px] font-medium text-baume-charcoal">{title}</span>
    </div>
  );
}