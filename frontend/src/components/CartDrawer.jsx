		...
		<Sheet open={open} onOpenChange={setOpen}>
			...
			>
				<SheetHeader className="sr-only">
					...
					<SheetDescription>
						Contenu du panier et passage au paiement
					</SheetDescription>
				</SheetHeader>
					...
					{empty ? (
						<div className="h-full flex flex-col items-center justify-center text-center gap-4 py-16">
							...
							<p className="text-[14px] text-baume-charcoal/60 max-w-[240px]">
								Découvrez nos sélections par besoin, par produit ou nos
								best-sellers.
							</p>
							<Link
								to="/"
							...
							{items.map((it) => (
								...
								>
									<img
										src={it.image}
										alt={it.name}
										className="h-20 w-16 object-cover rounded-lg bg-baume-white"
									/>
				...
				{!empty && (
					<div className="border-t border-baume-border p-6 space-y-4 bg-baume-white">
						<div className="flex items-center justify-between">
							<span className="text-[14px] text-baume-charcoal/70">
								Sous-total
							</span>
							<span className="font-medium text-[18px] text-baume-charcoal">
